        ...
        <Card className="p-6">
          <CardContent>
                  ...
                  return (
                    <button
                      ...
                      className={`w-full text-left px-4 py-2 border rounded-xl transition
                        ${isSelected ? "bg-sky-200 text-sky-900 border-sky-400" : "bg-white hover:bg-sky-100"}`}
                    >
                      {option}
                    </button>
                  );
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              <Button onClick={handlePrev} disabled={step === 0} variant="outline" className="w-full">
                이전
              </Button>
              <Button
                onClick={handleNext}
